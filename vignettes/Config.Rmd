...
The `taRantula` package uses a robust, `R6`-based configuration system for both scraping-jobs as well as Jobs based on Google Custom Search. This ensures that parameters are validated before scraping begins, reducing the risk of runtime errors in long-running parallel jobs.
